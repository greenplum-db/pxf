...
export PXF_CONFIG_DIR=${PXF_CONFIG_DIR:=/home/gpadmin/foobar/pxf}
source ${PXF_CONFIG_DIR}/conf/setenv.sh
...
export PXF_LOGDIR=${PXF_LOGDIR:=${PXF_CONFIG_DIR}/logs}
