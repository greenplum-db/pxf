...
SELECT id, bool_arr, bytea_arr, bigint_arr, small_arr, int_arr, text_arr, real_arr, float_arr, char_arr, varchar_arr, varchar_arr_nolimit, date_arr, timestamp_arr, round(numeric_arr, 18) as numeric, FROM pxf_parquet_write_array_with_hive_readable ORDER BY id;
