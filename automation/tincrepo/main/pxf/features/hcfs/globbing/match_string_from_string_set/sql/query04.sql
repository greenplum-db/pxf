...
--
-- m/Exception Report.*(java.io.IOException: Illegal file pattern: Unclosed group near index 4).*/
-- s/Report.*/Illegal file pattern: Unclosed group near index 4/
--
-- m/DETAIL/
-- s/DETAIL/CONTEXT/
--
-- m/pxf:\/\/(.*)\/pxf_automation_data/
-- s/pxf:\/\/.*match_string_from_string_set_4/pxf:\/\/pxf_automation_data?PROFILE/
--
-- m/CONTEXT:.*line.*/
-- s/line \d* of //g
--
