...
maven_path="maven/maven-3/${MAVEN_VERSION}/binaries"

response_json="$(curl -fsSL "https://www.apache.org/dyn/closer.lua/${maven_path}?as_json")"
...
if [ "$in_dist" == "false" ]; then
    ...
    download_url="https://archive.apache.org/dist/${maven_path}/${maven_dist}"
else
