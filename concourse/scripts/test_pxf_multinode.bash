...
EOF
	...
	ssh "${SSH_OPTS[@]}" gpadmin@mdw "
		...
		if [[ \"${PROTOCOL}\" == \"file\" ]]; then
			mkdir -p ${PXF_RUN_DIR}/servers/file
			cp ${PXF_HOME}/templates/mapred-site.xml ${PXF_RUN_DIR}/servers/file
			cp ${PXF_HOME}/templates/pxf-site.xml ${PXF_RUN_DIR}/servers/file
			sed -i \
