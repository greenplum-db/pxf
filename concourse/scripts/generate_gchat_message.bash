...
pxf_gp6_el9_releng_url="${RELENG_DROP_URL}/gpdb6/pxf-gp6-${version}-2.el9.x86_64.rpm"
...
pxf_gp7_el9_releng_url="${RELENG_DROP_URL}/gpdb7/pxf-gp7-${version}-2.el9.x86_64.rpm"
...
* <${pxf_gp5_tarball_releng_url}|${pxf_gp5_tarball_releng_url}>
* <${pxf_gp5_el7_releng_url}|${pxf_gp5_el7_releng_url}>
* <${pxf_gp5_osl_releng_url}|${pxf_gp5_osl_releng_url}>
* <${pxf_gp5_odp_releng_url}|${pxf_gp5_odp_releng_url}>

The GPDB6 artifacts are:
* <${pxf_gp6_tarball_releng_url}|{pxf_gp6_tarball_releng_url}>
* <${pxf_gp6_el7_releng_url}|{pxf_gp6_el7_releng_url}>
* <${pxf_gp6_el8_releng_url}|{pxf_gp6_el8_releng_url}>
* <${pxf_gp6_el9_releng_url}|{pxf_gp6_el9_releng_url}>
* <${pxf_gp6_ubuntu18_releng_url}|{pxf_gp6_ubuntu18_releng_url}>
* <${pxf_gp6_osl_releng_url}|{pxf_gp6_osl_releng_url}>
* <${pxf_gp6_odp_releng_url}|{pxf_gp6_odp_releng_url}>

The GPDB7 artifacts are:
* <${pxf_gp7_el8_releng_url}|{pxf_gp7_el8_releng_url}>
* <${pxf_gp7_el9_releng_url}|{pxf_gp7_el9_releng_url}>
* <${pxf_gp7_osl_releng_url}|{pxf_gp7_osl_releng_url}>
* <${pxf_gp7_odp_releng_url}|{pxf_gp7_odp_releng_url}>
