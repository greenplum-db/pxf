...
class _MPPMetaClassType(type):
    ...
    def __new__(cls, clsname, bases, dct):
        ...
        if (clsname.startswith('__') and clsname.endswith('__')) or (clsname is 'MPPTestCase'):
            # If here, our clsname is one of the product-specific hidden model or MPPTestCase
            # No need to check bases
            new_bases += bases
        else:
            # If here, we need to check each of our cls's bases
            ...
            for base in bases:
                ...
                try:
                    ...
                    new_bases += (base,)
        return super(_MPPMetaClassType, cls).__new__(cls, clsname, new_bases, dct)
