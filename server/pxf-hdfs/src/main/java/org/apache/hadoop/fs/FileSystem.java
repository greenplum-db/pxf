    ...
    static class Cache {
        ...
        static class Key {
            ...
            Key(URI uri, Configuration conf, long unique) throws IOException {
                ...
                this.sessionId = conf.get("pxf.session.id", null);
            }

            @Override
            public int hashCode() {
                if (sessionId != null) {
                    // If sessionId is provided, then ignore UGI
                    return (scheme + authority).hashCode() + sessionId.hashCode() + (int) unique;
                } else {
                ...
                if (obj != null && obj instanceof Key) {
                    ...
                    if (this.sessionId != null && that.sessionId != null) {
                        return isEqual(this.scheme, that.scheme)
                                ...
                                && isEqual(this.sessionId, that.sessionId)
            ...
            public String toString() {
                if (sessionId != null) {
                    return sessionId + "-(" + ugi.toString() + ")@" + scheme + "://" + authority;
                } else {
