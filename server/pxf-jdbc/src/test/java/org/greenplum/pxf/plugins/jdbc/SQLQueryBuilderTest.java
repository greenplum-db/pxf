...
public class SQLQueryBuilderTest {
    ...
    public void testIdFilter() throws Exception {
        ...
        SQLQueryBuilder builder = new SQLQueryBuilder(context, configuration, databaseMetaData);
    ...
    public void testIdMixedCase() throws Exception {
        ...
        SQLQueryBuilder builder = new SQLQueryBuilder(localContext, configuration, localDatabaseMetaData);
        builder.autoSetQuoteString();
        String query = builder.buildSelectQuery();
